    ...
    <?php if (isset($_SESSION['success_message'])) : ?>
        ...
        <div class="container_box3">
            <div class="box1">
                <h2>Description !</h2>
                <p>
                    je suis un homme pas comme les autres je fais du developement web depuis ma tendre enfance et je
                    suis tres douer pour ce qui est des outil informatique
                    <br>
                    je suis un homme pas comme les autres je fais du developement web depuis ma tendre enfance et je
                    suis tres douer pour ce qui est des outil informatique
                </p>
        ...
        <div class="container_box2">
            ...
            <?php foreach ($afficheOffreEmplois as $offres): ?>
                <div class="carousel">
                    ...
                    <div class="p" >
                        <p><?= $offres ['entreprise'] ?> </p>
                        <img class="img" src="../image/coeurs.png" alt="">
                    </div>
                    
                    <div class="vendu">
                        <p>nous recherchons un <?= $offres ['poste'] ?> 
                        </p>
                    </div>
                    <p id="nom"><?= $offres['date'] ?> </p>
